...
<div class="row mb-3 mt-3">
    ...
    <div class="col-md-4 ml-2">
        <form method="GET">
            <div class="input-group">
                <input type="text" class="form-control" name="search" placeholder="Tìm kiếm người dùng theo tên hoặc email"
    ...
    <!-- Cột 2: Tiêu đề (hoặc để trống nếu không cần) -->
    <div class="col-md-4 text-center d-flex align-items-center justify-content-center">
        <h5 class="mb-0">Quản lý người dùng</h5>
    </div>

    <!-- Cột 3: Nút Thêm người dùng -->
